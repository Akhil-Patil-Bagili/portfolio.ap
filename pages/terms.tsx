  ...
  return (
    <div className="min-h-screen bg-gray-50 text-black p-8">
      <div className="max-w-4xl mx-auto shadow-lg p-10 bg-white rounded-lg">
        ...
        <p className="mb-4">By accessing the website at <a href="https://portfolio.apatil.net/" className="text-blue-600 hover:underline">portfolio.apatil.net</a>, you are agreeing to be bound by these terms of service, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site.</p>
